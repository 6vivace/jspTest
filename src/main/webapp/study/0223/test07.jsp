...
<div class="container">
  ...
  <form name="myform" method="post" action="<%=request.getContextPath()%>/j0223/Test07">
    ...
    <div class="input-group mb-2">
      ...
      <input type="number" name="kor" value="100" min="0" max="100" class="form-control"/>
    </div>
    <div class="input-group mb-2">
      <div class="input-group-text">영어</div>
      <input type="number" name="eng" value="90" min="0" max="100" class="form-control"/>
    </div>
    <div class="input-group mb-2">
      <div class="input-group-text">수학</div>
      <input type="number" name="mat" value="80" min="0" max="100" class="form-control"/>
    </div>
    <div class="input-group mb-2">
      <div class="input-group-text">사회</div>
      <input type="number" name="soc" value="70" min="0" max="100" class="form-control"/>
    </div>
    <div class="input-group mb-2">
      <div class="input-group-text">과학</div>
      <input type="number" name="sci" value="60" min="0" max="100" class="form-control"/>
    </div>
