...
<head>
  ...
  <script>
  	...
  	function fCheck() {
  		...
  		let maxSize = 1024 * 1024 * 10;		// 파일 최대용량을 10 MByte로 설정
  		...
  		let fileSzie1 = document.getElementById("file1").files[0].size;
  		let fileSzie2 = document.getElementById("file2").files[0].size;
  		let fileSzie3 = document.getElementById("file3").files[0].size;
  		if(fileSzie1 > maxSize || fileSzie2 > maxSize || fileSzie3 > maxSize) {
  			alert("업로드할 파일의 최대용량은 10 MByte 입니다.");
  		}
